...
import com.justcan.library.dialog.pedant.SweetAlert.ProgressHelper;
import com.justcan.library.dialog.pnikosis.materialishprogress.ProgressWheel;
import com.justcan.library.dialog.titanic.Titanic;
import com.justcan.library.dialog.titanic.TitanicTextView;
...
//    public static final int DIALOG_STYLE_CUSTOM = -1;
     ...
     * 对话框宽度所占屏幕宽度的比例
     */
    public static final float WIDTHFACTOR = 0.85f;
    /**
     * 对话框透明比例
     */
    ...
    */
    ...
    public CBDialogBuilder(Context context, float widthcoefficient) {
        this(context, DIALOG_STYLE_NORMAL, false, widthcoefficient, ALPHAFACTOR, dimEnable);
    }
    ...
    public CBDialogBuilder setTitle(Object title) {
        ...
        if (dialogTitle != null) {
            if (title != null && !dialogTitle.getText().toString().equals("")) {
