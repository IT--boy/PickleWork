...
public class AppOrderListApi extends PostApi {

    public AppOrderListApi(HttpOnNextListener listener, RxAppActivity rxActivity) {
        super(listener, rxActivity);
        setAuth(false);
        setHmpCode(HttpConstants.APP_ORDER_LIST_N);
    }

    public AppOrderListApi(HttpOnNextListener listener, RxFragmentActivity rxActivity) {
        super(listener, rxActivity);
        setAuth(false);
        setHmpCode(HttpConstants.APP_ORDER_LIST_N);
    }
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return appService.appOrderList(getRequestBody());
    }
