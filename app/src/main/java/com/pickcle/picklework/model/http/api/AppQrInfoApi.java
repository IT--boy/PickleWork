...
public class AppQrInfoApi extends PostApi {

    public AppQrInfoApi(HttpOnNextListener listener, RxAppActivity rxActivity) {
        super(listener, rxActivity);
        setAuth(false);
        setHmpCode(HttpConstants.APP_QR_CODE_INFO_N);
    }
    public AppQrInfoApi(HttpOnNextListener listener, RxFragmentActivity rxActivity) {
        super(listener, rxActivity);
        setAuth(false);
        setHmpCode(HttpConstants.APP_QR_CODE_INFO_N);
    }
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return appService.appQrCodeInfo(getRequestBody());
    }
