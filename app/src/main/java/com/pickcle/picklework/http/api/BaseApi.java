...
public abstract class BaseApi<T> implements Func1<T, T> {
    //rx生命周期管理
    private SoftReference<RxAppActivity> rxActivity;
    ...
    public BaseApi(HttpOnNextListener listener) {
        setBaseUrl(PWApplication.getRequestUrl());
        setListener(listener);
    }

    public BaseApi(HttpOnNextListener listener, RxAppActivity rxAppCompatActivity) {
        setBaseUrl(PWApplication.getRequestUrl());
        setListener(listener);
        setRxActivity(rxAppCompatActivity);
    }

    public BaseApi(HttpOnNextListener listener, RxFragmentActivity rxFragmentActivity) {
        setBaseUrl(PWApplication.getRequestUrl());
        setListener(listener);
        setRxFragmentActivity(rxFragmentActivity);
    }
    ...
    public void setRxActivity(RxAppActivity rxActivity) {
        this.rxActivity = new SoftReference(rxActivity);
    }
    ...
    * @return
    */
    public RxAppActivity getRxActivity() {
        if (rxActivity != null) {
            return rxActivity.get();
        }
        return null;
    }
    ...
    public void setRxFragmentActivity(RxFragmentActivity rxFragmentActivity) {
        this.rxFragmentActivity = new SoftReference<RxFragmentActivity>(rxFragmentActivity);
    }

    public RxFragmentActivity getRxFragmentActivity() {
        if (rxFragmentActivity != null) {
            return rxFragmentActivity.get();
        }
        return null;
    }
