...
import com.pickcle.picklework.http.download.DownLoadListener.DownloadProgressListener;
...
import com.pickcle.picklework.http.utils.DbDownUtil;
...
public class ProgressDownSubscriber<T> extends Subscriber<T> implements DownloadProgressListener {
    ...
    public void onError(Throwable e) {
        ...
        if (e instanceof UnknownHostException) {
            ToastUtil.showToast(PWApplication.getContext(), R.string.network_wrong_tip);
        } else {
            ToastUtil.showToast(PWApplication.getContext(), R.string.http_error_server_down);
        }
    }
