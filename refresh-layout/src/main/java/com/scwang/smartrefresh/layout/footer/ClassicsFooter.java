    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (getPaddingTop() == 0) {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(6), getPaddingRight(), mPaddingBottom = density.dip2px(6));
            } else {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(6), getPaddingRight(), mPaddingBottom = getPaddingBottom());
            }
        } else {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = getPaddingTop(), getPaddingRight(), mPaddingBottom = density.dip2px(6));
            } else {
